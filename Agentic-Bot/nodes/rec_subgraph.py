...
def _rec_extract_slots(state: AgentState) -> AgentState:
    ...
    sys_msg = (
        ...
        "\n   - 'just me', 'only me', 'myself', 'by myself', 'alone', 'solo', 'single', 'individual' → extract coverage_scope='self'"
        "\n   - 'my family', 'with family', 'family coverage', 'family trip', 'with my family' → extract coverage_scope='family'"
        "\n   - 'group of adults', 'group coverage', 'adult group', 'friends' → extract coverage_scope='group_adults'"
        "\n   - 'group of families', 'multiple families' → extract coverage_scope='group_families'"
        "\n   DURATION EXTRACTION:"
        "\n   - 'about a week', 'around a week', 'roughly a week', 'approximately a week' → extract duration='7 days'"
        "\n   - 'few days', 'a few days', 'couple of days' → extract duration='3 days'"
        "\n   - 'couple weeks', 'two weeks', 'about two weeks' → extract duration='14 days'"
        "\n   DESTINATION EXTRACTION:"
        "\n   - 'Southeast Asia', 'somewhere in Asia', 'Asia region' → extract destination='Asia'"
        "\n   - 'somewhere in Europe', 'around Europe', 'European countries' → extract destination='Europe'"
